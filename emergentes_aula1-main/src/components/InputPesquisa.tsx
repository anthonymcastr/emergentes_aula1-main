      ...
      <form className="w-full" onSubmit={handleSubmit}>
        <div className="relative">
          <input
            ...
            placeholder="Informe a raça, tipo ou cidade"
            className="w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-2xl bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
          />
          <button
            type="submit"
